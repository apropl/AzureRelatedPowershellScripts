...
./PassthroughAPI/passthroughAPI.ps1 $repoRootFolder $Internal $apiName $operation $apiBasePath $Template $logicAppName $logicAppResourceGroup $functionAppName $functionAppResourceGroup $functionAppPath $backendServiceURLdev $backendServiceURLtest $backendServiceURLqa $backendServiceURLprod
cd $CurrentPath