...
$includeFunctions = "INT-Common-Functions-dev-fa"
$envResourceGroupName = "NordIntegration-dev-adp-rg"
$appinsightsName = "testai" # int-functionapplogs-dev-appinsights or testai
$appinsightsRG = "integration-common-dev-adp-rg" #NordIntegration-dev-adp-rg or 
